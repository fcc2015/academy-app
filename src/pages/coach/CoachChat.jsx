...
// ─────────────────────────
// Coach-specific Chat — no ban, no image sending
// Coach can: write, mute, view members, delete messages
// Coach cannot: ban users, send images, sync groups
// ─────────────────────────
...
export default function CoachChat() {
    ...
    const myRole   = 'coach';
    const myName   = localStorage.getItem('user_name') || 'Coach';
    ...
    // ── Send message (text only — coaches cannot send images)
            ...
            <div className={`w-full lg:w-[340px] lg:min-w-[280px] bg-white border-r border-slate-200 flex-col transition-all duration-300 ${activeGroup ? 'hidden lg:flex' : 'flex'}`}>
                <div style={{ padding: '20px 16px 12px', borderBottom: '1px solid #f3f4f6' }}>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
                        <div>
                            <h2 style={{ fontSize: 20, fontWeight: 900, color: '#0f172a', margin: 0 }}>🎽 Mes Groupes</h2>
                ...
                <div style={{ flex: 1, overflowY: 'auto' }}>
                    {filteredGroups.length === 0 ? (
                        <div style={{ padding: 32, textAlign: 'center', color: '#94a3b8' }}>
                            ...
                            <p style={{ fontSize: 12 }}>Vos groupes apparaîtront ici</p>
                        </div>
                ...
                {!activeGroup ? (
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 16, background: '#f0f2f5' }}>
                        ...
                        <div style={{ textAlign: 'center' }}>
                            ...
                            <p style={{ fontSize: 14, color: '#6b7280', fontWeight: 500 }}>Cliquez sur un groupe pour discuter avec votre équipe</p>
                        </div>
                    </div>
                ) : (
                    <>
                        ...
                        <div style={{ background: '#fff', padding: '10px 16px', display: 'flex', alignItems: 'center', gap: 12, boxShadow: '0 1px 4px rgba(0,0,0,0.08)', zIndex: 10 }}>
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    background: showMembers ? '#f0fdf4' : 'transparent',
                                    border: '1px solid #e5e7eb', borderRadius: 10,
                                    padding: '6px 12px', cursor: 'pointer', fontSize: 12,
                                    fontWeight: 800, color: showMembers ? '#059669' : '#6b7280'
                                }}
                            >
                                                    ...
                                                    <div key={msg.id} style={{ display: 'flex', justifyContent: isMe ? 'flex-end' : 'flex-start', marginBottom: 2, gap: 8, alignItems: 'flex-end' }}>
                                                        ...
                                                        <div style={{ maxWidth: '72%', display: 'flex', flexDirection: 'column', alignItems: isMe ? 'flex-end' : 'flex-start', gap: 2 }}>
                                                            ...
                                                            >
                                                                ...
                                                                {/* Coach can delete messages (moderator) */}
                                                                <button
                        ...
                        {/* Input Bar — text only for coaches (no images) */}
                        <div style={{ background: '#f0f2f5', padding: '10px 16px', display: 'flex', alignItems: 'center', gap: 10 }}>
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    background: inputMsg.trim() ? 'linear-gradient(135deg, #059669, #10b981)' : '#e5e7eb',
                                    display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0,
                                    transition: 'all 0.2s', boxShadow: inputMsg.trim() ? '0 4px 14px rgba(5,150,105,0.4)' : 'none'
                                }}
                            >
