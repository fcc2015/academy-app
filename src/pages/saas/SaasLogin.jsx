            ...
            <div className="relative w-full max-w-md mx-4">
                ...
                <div className="text-center mb-6 flex flex-col items-center">
                    ...
                    <h1 className="text-2xl font-black text-white tracking-tight">
                        {isRTL ? 'دخول الإدارة العامة (SaaS)' : 'SaaS Admin Portal'}
                    </h1>
                    <p className="text-sm text-indigo-300/70 mt-1 font-medium">
                        {isRTL ? 'بوابة الإدارة المحمية — خاص بمالك المنصة' : 'Portail sécurisé — réservé au propriétaire de la plateforme'}
                    </p>
                </div>
